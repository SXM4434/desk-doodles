...
const V = [
  { g: "finalist", name: "A-greyscale", surface: "greyscale", dark: 0.18, contrast: 1 },
  { g: "finalist", name: "B-matte-outline50", surface: "native", preset: "matteClay", nativeProps: { ...N, outline: 0.5 } },
  { g: "finalist", name: "C-crosshatch-mid", surface: "hatch", grammar: "cross-hatch", mods: { hachureGap: 6, strokeWidth: 1.0, inkIntensity: 0.85 } },
  { g: "finalist", name: "D-contour", surface: "hatch", grammar: "contour", direction: "fixed" },
  { g: "outline", name: "matte-outline-0", surface: "native", preset: "matteClay", nativeProps: { ...N, outline: 0 } },
  { g: "outline", name: "matte-outline-25", surface: "native", preset: "matteClay", nativeProps: { ...N, outline: 0.25 } },
  { g: "outline", name: "matte-outline-50", surface: "native", preset: "matteClay", nativeProps: { ...N, outline: 0.5 } },
  { g: "outline", name: "matte-outline-75", surface: "native", preset: "matteClay", nativeProps: { ...N, outline: 0.75 } },
  { g: "outline", name: "matte-outline-100", surface: "native", preset: "matteClay", nativeProps: { ...N, outline: 1 } },
  { g: "outline", name: "ink-outline-50", surface: "native", preset: "ink", nativeProps: { ...N, outline: 0.5 } },
  { g: "micro", name: "gap3-w06", surface: "hatch", grammar: "cross-hatch", mods: { hachureGap: 3, strokeWidth: 0.6 } },
  { g: "micro", name: "gap3-w15", surface: "hatch", grammar: "cross-hatch", mods: { hachureGap: 3, strokeWidth: 1.5 } },
  { g: "micro", name: "gap6-w06", surface: "hatch", grammar: "cross-hatch", mods: { hachureGap: 6, strokeWidth: 0.6 } },
  { g: "micro", name: "gap6-w15", surface: "hatch", grammar: "cross-hatch", mods: { hachureGap: 6, strokeWidth: 1.5 } },
  { g: "micro", name: "gap10-w06", surface: "hatch", grammar: "cross-hatch", mods: { hachureGap: 10, strokeWidth: 0.6 } },
  { g: "micro", name: "gap6-int60", surface: "hatch", grammar: "cross-hatch", mods: { hachureGap: 6, strokeWidth: 1.0, inkIntensity: 0.6 } },
];
