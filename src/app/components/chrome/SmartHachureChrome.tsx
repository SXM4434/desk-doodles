// VERBATIM port of Hero8Shell.tsx Row 7 modifier panel (lines 874-993).
// Same conditional patterns, same constants, same sub-conditionals.
// Only diff from Hero8Shell: drop the onF3BRoute/path-2-svg route gating
// (playground always shows this chrome).
//
// DO NOT improve / redesign / collapse / "simplify" this.
// If a toggle needs to change, change it in Hero8Shell first, then mirror here.
...
export function SmartHachureChrome() {
  ...
  return (
    ...
    >
      {/* STYLE picker — sits above the cluster rows. Selecting a new style
          changes which modifiers are exposed via MODIFIER_SETS_BY_STYLE. */}
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-end', gap: 12 }}>
        <span style={{ ...labelStyle, marginRight: 8 }}>Style</span>
        <Dropdown
          label="SVG style"
          value={svgStyle}
          sections={[{
      ...
      {/* CLUSTER 1 — Multi-Stroke (per 09-LOCKED-MODEL.md I-13 + doc 19 §E).
          Wobble is the cluster master (path/motion). */}
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-end', gap: 12 }}>
